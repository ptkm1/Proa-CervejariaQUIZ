      ...
      <Cervejas>
        ...
        <Row>
        {
          ...
          <RefazendoBloco2 key={e.title}>
              ...
              <Row>
                <a style={{ background: '#64358C', width: 'max-content', height: 'max-content', padding: '15px', marginLeft: '0', color: 'white', textDecoration: 'none' }} href={`https://api.whatsapp.com/send?phone=557196805838&text=Marcar encontro com a Proa ${e.titulo}.`}>Marcar Encontro</a>
              </Row>
            </RefazendoBloco2>
            </>
        ))
